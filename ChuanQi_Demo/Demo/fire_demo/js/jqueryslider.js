...
(function($) {
    $.fn.ZHYslider = function(options) {
        ...
        for (var i = 1; i <= $contents_len; i++) { i == 1 ? html += "<a href='javascript:;' class='cur'></a>" : html += "<a href='javascript:;'></a>"; }
        ...
        if (settings.rand) { index = Math.floor(Math.random() * $contents_len);
            settings._slide(); }
